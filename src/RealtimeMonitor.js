...
function RealtimeMonitor() {
  ...
  return (
    <div>
        ...
        <div className="center">
          <div className="speedometr">
            ...
            >
              ...
              {/* Markings */}
              {[226, 253, 280, 307, 334, 361, 388, 415, 442, 469, 494].map(
                (angle, index) => (
                  <line
                    key={index}
                    className="metka"
              ...
              <text x="50" y="222" className="number">
                10
              </text>
              <text x="48" y="162" className="number">
                20
              </text>
              <text x="75" y="110" className="number">
                30
              </text>
              <text x="117" y="74" className="number">
                40
              </text>
              <text x="175" y="65" className="number">
                50
              </text>
              <text x="227" y="74" className="number">
                60
              </text>
              <text x="270" y="110" className="number">
                70
              </text>
              <text x="290" y="162" className="number">
                80
              </text>
              <text x="285" y="222" className="number">
                90
              </text>
              <text x="250" y="275" className="number">
                100
              </text>
            </svg>
            <div
      ...
      <div
        className="container memory-speedometer"
        style={{ position: "absolute", left: "21.5%", top: "62%" }}
      >
        <div className="center">
          <div className="speedometr">
            <svg
            ...
            <div
              id="speed-number-memory"
              ref={memorySpeedNumberRef}
              className="speed-number"
              style={{
                fontFamily: "'Orbitron', sans-serif",
                fontSize: "18px",
      ...
      <div
        className="container disk-speedometer"
        style={{ position: "absolute", left: "78%", top: "62%" }}
      >
        <div className="center">
          <div className="speedometr">
            <svg
            ...
            <div
              id="speed-number-disk"
              ref={diskSpeedNumberRef}
              className="speed-number"
              style={{
                fontFamily: "'Orbitron', sans-serif",
                fontSize: "18px",
      ...
      <div
        className="container processes-speedometer"
        style={{ position: "absolute", left: "50%", top: "110%" }}
      >
        <div className="center">
          {/* Wrap the speedometer in a clickable div */}
          <div
            className="speedometr"
            onClick={handleProcessSpeedometerClick}
          ...
          >
            ...
            <div
              id="speed-number-process"
              ref={processesSpeedNumberRef}
              className="speed-number"
              style={{
                fontFamily: "'Orbitron', sans-serif",
                fontSize: "18px",
